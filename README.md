...
- **Пользователь** ([`user`](https://github.com/syeysk/sy_api/blob/master/syapi/auth.py)) - множество свойств, обеспечивающих доступ **пользователя** к управлению **микросервисом**
