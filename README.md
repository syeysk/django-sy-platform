...
- **Микросервис** - программное обеспечение и электроника, обеспечивающих доступ к управлению фабрикой (например, микросервис заметок, микросервис 3D-печати).
...
В контексте программирования есть и другие сущности, порождённых микросервисами:
